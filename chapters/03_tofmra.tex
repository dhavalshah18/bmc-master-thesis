...
\todo{Write here, talk about preprocessing done for data in general, what most deep learning methods expect of their data and why, and the preprocessing done for my architecture}
